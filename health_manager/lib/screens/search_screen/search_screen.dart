                  ...
                  onChanged: (val){
                    setState(() {
                      if(val.isEmpty)
                        ...
                        filterPosts = widget.posts.where((element) => element['description'].toString().toLowerCase().contains(val.toLowerCase())).toList();                      
                    });
                  },
                ...
                child: MediaQuery.removePadding(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index){
                      return feedCell(filterPosts[index], index);
                    }
                  ),
                ),
              ),
