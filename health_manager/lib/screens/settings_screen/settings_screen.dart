...
import 'package:health_manager/screens/login_screen/login_screen.dart';
import 'package:health_manager/screens/user_posts/user_own_posts.dart';
...
import '../user_posts/my_favorites.dart';
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            listCell('My Posts', Icons.list_alt, 7),
            listCell('My Favorites', Icons.favorite, 8),
