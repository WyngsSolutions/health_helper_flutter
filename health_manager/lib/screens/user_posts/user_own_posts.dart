          ...
          children: [
            Row(
              children: [
                ...
                GestureDetector(
                  onTap: () async {
                    dynamic results = await Get.to(EditPost(postDetail: postData));
                    if(results != null)
                      getAllPosts();
                  },
                  child: Container(
                    margin: EdgeInsets.only(left: 10),
                    child: Icon(Icons.edit_outlined, color: Constants.appThemeColor, size : SizeConfig.blockSizeVertical*3),
                  ),
                ),
                GestureDetector(
                  onTap: (){
                    deleteUserPost(postData, index);
                  },
                  child: Container(
